...
This file is the instruction router. Keep it short.

## Context Loading

- Before making code changes, read `README.md`.
- Before resuming or changing work, read `PROJECT_STATE.md`.
- For implementation work, read `RULES.md` and `PROCESS.md`.
